...
#define MCUR(line, col) "\e[" line ";" col "H" /**   moves cursor up # lines */
#define MCUR1_FMT "\e[%d%c"                    /**   moves cursor up # lines */
#define MCURUP_FMT "\e[%ldA"
#define MCURDO(_n) "\e[%ldB"             /**   moves cursor down # lines */
#define MCURRI(_n) "\e[%ldC"             /**   moves cursor right # columns */
#define MCURLE(_n) "\e[%ldD"             /**   moves cursor left # columns */
#define MCURNB(_n) "\e[%ldD"             /**   moves cursor to beginning of next line, # lines down */
#define MCURPB(_n) "\e[%ldF"             /**   moves cursor to beginning of previous line, # lines up */
